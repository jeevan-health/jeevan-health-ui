  ...
  if (submitted) {
    return (
      <div style={{
        ...
        <div style={{
          background: 'linear-gradient(180deg, #0F5DA8 0%, #0C6BC4 100%)',
          ...
          <div style={{ padding: '48px 36px 36px', background: '#fff', borderRadius: '0 0 var(--radius-lg) var(--radius-lg)', marginTop: 4 }}>
            ...
            <div style={{
              ...
              fontSize: 13, color: '#0F5DA8', fontWeight: 700, marginBottom: 16,
            }}>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <form style={{ display: 'flex', flexDirection: 'column', gap: 0, padding: '24px 36px 32px' }} onSubmit={handleSubmit}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14, marginBottom: 18 }}>
            <div>
              <label style={{ fontSize: 12, fontWeight: 600, color: '#374151', marginBottom: 5, display: 'flex', alignItems: 'center', gap: 4 }}>
                <User size={13} weight="fill" color="#0F5DA8" /> Your Name <span style={{ color: '#0F5DA8' }}>*</span>
              </label>
          ...
          <div style={{ marginBottom: 18 }}>
            <label style={{ fontSize: 12, fontWeight: 600, color: '#374151', marginBottom: 5, display: 'flex', alignItems: 'center', gap: 4 }}>
              <ClipboardText size={13} weight="fill" color="#0F5DA8" /> Select Service
            </label>
          ...
          <div style={{ marginBottom: 18 }}>
            <label style={{ fontSize: 12, fontWeight: 600, color: '#374151', marginBottom: 5, display: 'flex', alignItems: 'center', gap: 4 }}>
              <FileText size={13} weight="fill" color="#0F5DA8" /> Upload Prescription
            </label>
            {prescription ? (
              <div style={{
          ...
          <button type="submit" disabled={!canSubmit || submitting} style={{
            background: !canSubmit || submitting ? '#d1d5db' : 'linear-gradient(135deg, #0F5DA8, #0C6BC4)',
