...
export default function PharmacyOrders() {
  ...
  return (
    <div>
      <h2 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', margin: '0 0 4px' }}>📋 Pharmacy Orders</h2>
      <p style={{ fontSize: 12, color: '#64748b', margin: '0 0 16px' }}>Order fulfillment and tracking</p>
      {items.length === 0 && <p style={{ textAlign: 'center', color: '#94a3b8', fontSize: 13, padding: 40 }}>No orders yet.</p>}
