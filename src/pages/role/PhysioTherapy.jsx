...
export default function PhysioTherapy() {
  return (
    <div>
      <h2 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', margin: '0 0 4px' }}>📋 Therapy Plans</h2>
      <p style={{ fontSize: 12, color: '#64748b', margin: '0 0 16px' }}>{SAMPLE_PLANS.length} active plans</p>
        ...
        <div key={i} style={card}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
              ...
              <div style={{ fontSize: 12, color: '#64748b' }}>Progress: {p.sessions} sessions</div>
            </div>
