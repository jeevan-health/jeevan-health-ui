...
export default function DispatchSchedule() {
  return (
    <div>
      <h2 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', margin: '0 0 4px' }}>📅 Dispatch Schedule</h2>
      <p style={{ fontSize: 12, color: '#64748b', margin: '0 0 16px' }}>Collection and delivery routing</p>
      {SAMPLE.map((s, i) => (
        <div key={i} style={{ ...card, border: s.status === 'active' ? '2px solid #f97316' : '1px solid #e2e8f0' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
              ...
              <div style={{ fontSize: 12, color: '#64748b' }}>{s.filled}/{s.slots} slots filled</div>
            </div>
