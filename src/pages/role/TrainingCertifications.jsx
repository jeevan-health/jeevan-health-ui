...
export default function TrainingCertifications() {
  return (
    <div>
      <h2 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', margin: '0 0 4px' }}>📜 Certifications</h2>
      <p style={{ fontSize: 12, color: '#64748b', margin: '0 0 16px' }}>Staff training certifications and validity</p>
      {SAMPLE.map((c, i) => (
        <div key={i} style={card}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
              ...
              <div style={{ fontSize: 11, color: '#94a3b8' }}>{c.date} → Valid till {c.validTill}</div>
            </div>
