...
export default function AnalyticsDashboard() {
  ...
  return (
    <div>
      <h2 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', margin: '0 0 4px' }}>📊 Welcome, {user?.name || 'Analyst'}</h2>
      ...
      <div style={{ display: 'grid', gap: 12, gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', marginBottom: 16 }}>
        <div style={{ ...card, padding: 16, textAlign: 'center', marginBottom: 0 }}><div style={{ fontSize: 24, fontWeight: 800, color: '#6d28d9' }}>₹{(revenue).toLocaleString()}</div><div style={{ fontSize: 11, color: '#64748b', marginTop: 2 }}>Lifetime Revenue</div></div>
        <div style={{ ...card, padding: 16, textAlign: 'center', marginBottom: 0 }}><div style={{ fontSize: 24, fontWeight: 800, color: '#6d28d9' }}>{orders.length}</div><div style={{ fontSize: 11, color: '#64748b', marginTop: 2 }}>Total Orders</div></div>
        <div style={{ ...card, padding: 16, textAlign: 'center', marginBottom: 0 }}><div style={{ fontSize: 24, fontWeight: 800, color: '#6d28d9' }}>₹{avgOrder}</div><div style={{ fontSize: 11, color: '#64748b', marginTop: 2 }}>Avg Order Value</div></div>
        <div style={{ ...card, padding: 16, textAlign: 'center', marginBottom: 0 }}><div style={{ fontSize: 24, fontWeight: 800, color: '#6d28d9' }}>{completed.length}</div><div style={{ fontSize: 11, color: '#64748b', marginTop: 2 }}>Completed Orders</div></div>
      </div>
      <div style={{ display: 'grid', gap: 16, gridTemplateColumns: '1fr 1fr' }}>
        <div style={card}>
          <h4 style={{ fontSize: 13, fontWeight: 700, color: '#0f172a', margin: '0 0 10px' }}>📆 This Month</h4>
        ...
        <div style={card}>
          <h4 style={{ fontSize: 13, fontWeight: 700, color: '#0f172a', margin: '0 0 10px' }}>📊 Status Breakdown</h4>
