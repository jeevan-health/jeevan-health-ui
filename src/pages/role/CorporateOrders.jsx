...
export default function CorporateOrders() {
  ...
  return (
    <div>
      <h2 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', margin: '0 0 4px' }}>📋 Corporate Orders</h2>
      <p style={{ fontSize: 12, color: '#64748b', margin: '0 0 16px' }}>Bulk orders and corporate account requests</p>
      {orders.length === 0 && <p style={{ textAlign: 'center', color: '#94a3b8', fontSize: 13, padding: 40 }}>No corporate orders yet.</p>}
