...
const SAMPLE = [
  { name: 'Rajesh K', role: 'Paramedic', zone: 'Zone A', status: 'on_duty', phone: '9876543001' },
  { name: 'Sneha M', role: 'EMT', zone: 'Zone B', status: 'on_duty', phone: '9876543002' },
  { name: 'Vikram S', role: 'Driver', zone: 'Zone A', status: 'available', phone: '9876543003' },
  { name: 'Anita P', role: 'Paramedic', zone: 'Zone C', status: 'on_break', phone: '9876543004' },
  { name: 'Kiran D', role: 'Coordinator', zone: 'HQ', status: 'on_duty', phone: '9876543005' },
];
