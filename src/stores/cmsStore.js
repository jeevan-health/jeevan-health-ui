...
const defaults = {
  ...
  seo: {
    routes: {
      ...
      '/health-packages': { title: 'Health Packages — Full Body Checkups & Preventive Screenings', description: 'Comprehensive health checkup packages at home. Full body, diabetes, cardiac, thyroid, women\'s health & more.', ogImage: '' },
      '/nurse-at-home': { title: 'Nurse at Home — Trained Nursing Staff at Your Doorstep', description: 'Book trained nurses at home for wound care, injection, IV infusion, catheter care, post-surgery care & more.', ogImage: '' },
      '/nursing-care': { title: 'Nursing Care at Home — Professional Healthcare at Home', description: 'Professional nursing care services at home. Trained & verified nurses for all your healthcare needs.', ogImage: '' },
      '/physiotherapy': { title: 'Physiotherapy at Home — Expert Physiotherapists at Your Doorstep', description: 'Book expert physiotherapists at home. Back pain, knee pain, stroke rehabilitation, sports injury recovery & more.', ogImage: '' },
      '/vaccination': { title: 'Vaccination at Home — Book Vaccines at Your Doorstep', description: 'Book vaccination at home for babies, children, adults & seniors. All vaccines delivered by trained professionals.', ogImage: '' },
      '/medical-equipment': { title: 'Medical Equipment Rental & Purchase at Home', description: 'Rent or buy medical equipment at home. Oxygen concentrators, hospital beds, wheelchairs, CPAP machines & more.', ogImage: '' },
      '/icu-at-home': { title: 'ICU at Home — Hospital-Level Critical Care at Home', description: 'ICU at home service with trained medical staff, critical care equipment, and 24/7 monitoring.', ogImage: '' },
      '/consult-doctor': { title: 'Consult Doctor Online — Book Appointment with Top Doctors', description: 'Online doctor consultation from home. Consult top doctors for general medicine, pediatrics, gynecology & more.', ogImage: '' },
      '/upload-prescription': { title: 'Upload Prescription — Order Lab Tests at Home', description: 'Upload your prescription and we will recommend & book the right lab tests at home. Free home sample collection.', ogImage: '' },
      '/my-bookings': { title: 'My Bookings — View & Manage Your Appointments', description: 'View and manage all your healthcare bookings — lab tests, nursing, physiotherapy, vaccination appointments at home.', ogImage: '' },
      '/signup': { title: 'Sign Up — Create Your Jeevan HealthCare Account', description: 'Create your Jeevan HealthCare at Home account to book tests, manage orders, track reports, and access health records.', ogImage: '' },
      '/vaccination-at-home': { title: 'Vaccination at Home — Safe & Convenient', description: 'Full vaccination services at home. Baby vaccination, adult vaccination, travel vaccines, flu shots & more.', ogImage: '' },
      '/back-pain-treatment': { title: 'Back Pain Treatment at Home — Physiotherapy', description: 'Expert physiotherapy for back pain at home. Personalized treatment plans, one-on-one sessions with experienced physiotherapists.', ogImage: '' },
      '/knee-pain-physiotherapy': { title: 'Knee Pain Physiotherapy at Home', description: 'Specialized physiotherapy for knee pain relief at home. Expert therapists, proven techniques for lasting relief.', ogImage: '' },
      '/stroke-rehabilitation': { title: 'Stroke Rehabilitation at Home — Physiotherapy', description: 'Post-stroke rehabilitation physiotherapy at home. Regain mobility and independence with expert care.', ogImage: '' },
      '/post-surgery-physiotherapy': { title: 'Post-Surgery Physiotherapy at Home', description: 'Recover faster with post-surgery physiotherapy at home. Personalized rehabilitation plans by expert therapists.', ogImage: '' },
      '/sports-physiotherapy': { title: 'Sports Physiotherapy at Home — Injury Recovery', description: 'Sports injury physiotherapy at home. Expert care for athletes, personalized recovery programs.', ogImage: '' },
      '/elderly-physiotherapy': { title: 'Elderly Physiotherapy at Home — Geriatric Care', description: 'Geriatric physiotherapy at home for seniors. Improve mobility, balance, and quality of life with expert care.', ogImage: '' },
    },
  },
  stats: [
