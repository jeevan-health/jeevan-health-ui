...
const sections = [
  { key: 'services', label: 'Services', links: [
    ...
    { label: 'Home Nursing', path: '/nursing-care' },
    { label: 'Caregiver Services', path: '/nursing-care' },
  ...
  { key: 'nursing', label: 'Nursing & Caregiver', links: [
    { label: '🩹 Wound Care & Dressing', path: '/nursing-care' },
    { label: '💉 Injections & IV Therapy', path: '/nursing-care/services' },
    { label: '👴 Elderly & Palliative Care', path: '/nursing-care/services' },
    { label: '🏥 Post-Surgery Care', path: '/nursing-care/services' },
    { label: '👶 Mother & Baby Care', path: '/nursing-care/services' },
    { label: '🛏️ 24/7 Bedside Nursing', path: '/nursing-care/services' },
    { label: '💪 Rehabilitation Therapy', path: '/nursing-care/services' },
    { label: '📋 All Nursing Services', path: '/nursing-care/services' },
    { label: '📅 My Visits', path: '/nursing-care/my-visits' },
    { label: '📖 Book a Nurse', path: '/nursing-care/book' },
  ]},
