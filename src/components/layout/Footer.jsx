...
const sections = [
  { key: 'services', label: 'Services', links: [
    ...
    { label: 'Home Nursing', path: '/nurse-at-home' },
    { label: 'Caregiver Services', path: '/nurse-at-home' },
    { label: 'ICU at Home', path: '/icu-at-home' },
    { label: 'Medical Equipment Rental', path: '/medical-equipment' },
    { label: 'Physiotherapy', path: '/physiotherapy' },
    { label: 'Corporate Health Checkups', path: '/services' },
    { label: 'Health Camps', path: '/contact' },
  ]},
  { key: 'categories', label: 'Tests by Category', links: [
    { label: '🩸 Blood Tests', path: '/tests/blood-tests' },
    { label: '🩸 Diabetes Tests', path: '/tests/diabetes' },
    { label: '🦋 Thyroid Tests', path: '/tests/thyroid' },
    { label: '❤️ Heart Health', path: '/tests/heart-health' },
    { label: '🧬 Full Body Checkup', path: '/tests/full-body' },
    { label: '🫁 Liver Health', path: '/tests/liver-health' },
    { label: '🦠 Fever & Infection', path: '/tests/fever-infection' },
    { label: '💊 Vitamins', path: '/tests/vitamins-nutrition' },
    { label: '🎗️ Cancer Screening', path: '/tests/cancer-screening' },
    { label: '🤰 Pregnancy Tests', path: '/tests/pregnancy-fertility' },
  ...
  { key: 'physio', label: 'Physiotherapy', links: [
    ...
    { label: '🔙 Back Pain Treatment', path: '/back-pain-treatment' },
    { label: '🦵 Knee Pain Physiotherapy', path: '/knee-pain-physiotherapy' },
    { label: '🧠 Stroke Rehabilitation', path: '/stroke-rehabilitation' },
    { label: '🏥 Post Surgery Rehab', path: '/post-surgery-physiotherapy' },
    { label: '⚽ Sports Physiotherapy', path: '/sports-physiotherapy' },
    { label: '👴 Elderly Physiotherapy', path: '/elderly-physiotherapy' },
    { label: '🏠 Home Physiotherapy', path: '/physiotherapy-at-home' },
    { label: '💻 Online Consultation', path: '/physiotherapy/book' },
    { label: '📋 My Sessions', path: '/physiotherapy/my-sessions' },
    { label: '🦴 Orthopedic', path: '/physiotherapy/category/orthopedic-physiotherapy' },
    { label: '🧠 Neurological', path: '/physiotherapy/category/neurological-physiotherapy' },
  ]},
  { key: 'nursing', label: 'Nurse at Home', links: [
    { label: '🏠 Nurse at Home', path: '/nurse-at-home' },
    { label: '🩹 Wound Care & Dressing', path: '/nurse-at-home/services' },
    { label: '💉 Injections & IV Therapy', path: '/nurse-at-home/services' },
    { label: '👴 Elderly & Palliative Care', path: '/nurse-at-home/services' },
    { label: '🏥 Post-Surgery Care', path: '/nurse-at-home/services' },
    { label: '👶 Mother & Baby Care', path: '/nurse-at-home/services' },
    { label: '🛏️ 24/7 Bedside Nursing', path: '/nurse-at-home/services' },
    { label: '💪 Rehabilitation Therapy', path: '/nurse-at-home/services' },
    { label: '🆘 ICU at Home', path: '/icu-at-home' },
  ...
  { key: 'packages', label: 'Health Packages', links: [
    ...
    { label: 'Advanced Full Body Checkup', path: '/package/advanced-full-body' },
    { label: 'Executive Health Checkup', path: '/package/executive-health' },
    { label: '🩸 Diabetes Care Package', path: '/package/diabetes-care' },
    { label: '🦋 Thyroid Care Package', path: '/package/thyroid-care' },
    { label: '❤️ Heart Care Package', path: '/package/heart-care' },
    { label: "👩 Women's Wellness", path: '/package/womens-wellness' },
    { label: '👨 Men\'s Wellness', path: '/package/mens-wellness' },
    { label: '👴 Senior Citizen', path: '/package/senior-citizen' },
    { label: '🦠 Fever & Infection', path: '/package/fever-infection' },
    { label: '💊 Vitamin Deficiency', path: '/package/vitamin-deficiency' },
