...
const NAV_ITEMS = [
  ...
  { path: '/admin/catalog', label: 'Catalog (Legacy)', icon: '📋' },
...
export default function AdminLayout() {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: '#f1f5f9' }}>
      {/* Sidebar — Light Theme */}
      <aside style={{
        width: collapsed ? 64 : 240, background: '#fff', color: '#334155',
        transition: 'width 0.2s', display: 'flex', flexDirection: 'column',
        position: 'sticky', top: 0, height: '100vh', overflow: 'hidden',
        borderRight: '1px solid #e2e8f0', boxShadow: '0 1px 3px rgba(0,0,0,0.04)',
      }}>
        {/* Brand Header */}
        <div style={{
        ...
        {/* User Footer */}
        <div style={{ padding: collapsed ? '8px' : '12px 20px', borderTop: '1px solid #f1f5f9', background: '#fafbfc' }}>
          <div style={{
