const policies = {
  'privacy-policy': {
    ...
    sections: [
      ...
      { heading: 'Data Sharing', content: 'We do not sell your personal information. We may share data with: (a) Laboratories and diagnostic partners for test processing, (b) Healthcare professionals involved in your care, (c) Regulatory authorities as required by law, (d) Service providers who assist in our business operations under strict confidentiality agreements.' },
      { heading: 'Your Rights', content: 'You have the right to: access your personal data, request corrections, request deletion, withdraw consent at any time, lodge a complaint with relevant authorities, and request data portability.' },
      { heading: 'Cookies', content: 'We use cookies to enhance your browsing experience, analyze site traffic, and personalize content. You can control cookie preferences through your browser settings.' },
      { heading: 'Contact Us', content: 'For privacy-related queries, please contact our Data Protection Officer at privacy@jeevanhealth.com or call 1800-XXX-XXXX.' },
    ],
  },
  ...
  'refund-policy': {
    ...
    sections: [
      ...
      { heading: 'Technical Errors', content: 'If a technical error on our platform results in incorrect charges, a full refund will be issued promptly.' },
      { heading: 'Refund Processing Time', content: 'Refunds are processed within 5-7 business days. The time for the refund to reflect in your account depends on your payment method and bank.' },
      { heading: 'How to Request a Refund', content: 'Contact our customer care team at care@jeevanhealth.com or call 1800-XXX-XXXX with your order details to initiate a refund request.' },
    ],
  },
  'cancellation-policy': {
    ...
    lastUpdated: '1st January 2025',
    sections: [
      { heading: 'Order Cancellation', content: 'You may cancel your diagnostic test order at any time before sample collection without any charges.' },
      { heading: 'Same-Day Cancellation', content: 'Cancellations on the scheduled collection day may incur a nominal fee of up to 20% of the order value to cover logistics and scheduling costs.' },
      { heading: 'Home Collection Cancellation', content: 'Home collection appointments can be rescheduled or cancelled up to 2 hours before the scheduled time slot.' },
      { heading: 'Package Cancellation', content: 'Health package cancellations follow the same policy as individual test orders. However, partially utilized packages are not eligible for refund on the used components.' },
      { heading: 'How to Cancel', content: 'Log into your account and navigate to My Orders, or contact our customer care team. We will assist you with the cancellation process.' },
    ],
  },
  'shipping-policy': {
    ...
    lastUpdated: '1st January 2025',
    sections: [
      { heading: 'Sample Collection', content: 'Our trained phlebotomists collect samples from your home or office within the scheduled time slot. Collection is FREE for all orders above ₹499.' },
      { heading: 'Coverage Area', content: 'We currently serve all major areas in Bangalore. Additional locations are being added regularly. Check your pincode availability during checkout.' },
      { heading: 'Report Delivery', content: 'Test reports are delivered digitally via email and WhatsApp within 24-72 hours of sample collection, depending on the test complexity. Physical copies can be requested.' },
      { heading: 'Sample Handling', content: 'Samples are transported in temperature-controlled conditions to our NABL-accredited partner laboratories following all safety protocols.' },
      { heading: 'Delay Policy', content: 'In case of any delay beyond the committed turnaround time, we will notify you immediately and provide an updated timeline.' },
    ],
  },
  'cookie-policy': {
    title: 'Cookie Policy',
    lastUpdated: '1st January 2025',
    sections: [
      { heading: 'What Are Cookies', content: 'Cookies are small text files stored on your device when you visit a website. They help us enhance your browsing experience and provide personalized services.' },
      { heading: 'Types of Cookies We Use', content: 'Essential Cookies: Required for website functionality. Analytics Cookies: Help us understand how visitors interact with our site. Preference Cookies: Remember your settings and preferences. Marketing Cookies: Used to deliver relevant advertisements.' },
      { heading: 'Third-Party Cookies', content: 'We may use third-party services like Google Analytics that set their own cookies. These are governed by the respective third-party privacy policies.' },
      { heading: 'Managing Cookies', content: 'You can control and manage cookies through your browser settings. Please note that disabling certain cookies may affect website functionality.' },
      { heading: 'Updates to This Policy', content: 'We may update this Cookie Policy periodically. Changes will be posted on this page with an updated revision date.' },
    ],
  },
  disclaimer: {
    title: 'Disclaimer',
  ...
  'data-protection': {
    ...
    sections: [
      ...
      { heading: 'Data Subject Rights', content: 'Under the DPDPA, you have rights including: right to access, right to correction, right to deletion, right to data portability, right to withdraw consent, and right to nominate.' },
      { heading: 'Data Breach Notification', content: 'In the event of a data breach that may pose a risk to your rights and freedoms, we will notify you and the relevant authorities within the timeframe required by law.' },
      { heading: 'International Transfers', content: 'Your data may be transferred to and processed in jurisdictions outside India. We ensure appropriate safeguards are in place for such transfers.' },
    ],
  },
  'consent-policy': {
    ...
    sections: [
      ...
      { heading: 'Communication Consent', content: 'By providing your contact information, you consent to receive service-related communications (appointment reminders, reports) and, with separate consent, promotional communications.' },
    ],
  },
};
